...
interface SettingPathsInterface
{
    ...
    /** Select whether the EAN attribute should be included in the catalog export. */
    const SETTING_CATALOG_EXPORT_EXPORT_EAN                         = 'catalog_export_settings/export_ean';

    /** EffectConnect only supports products with a valid EAN or products without an EAN. */
    const SETTING_CATALOG_EXPORT_EXPORT_PRODUCTS_WHEN_EAN_INVALID   = 'catalog_export_settings/export_products_when_ean_invalid';
