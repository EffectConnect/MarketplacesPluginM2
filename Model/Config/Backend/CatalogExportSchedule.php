...
class CatalogExportSchedule extends AbstractSchedule
{
     ...
     * Cron string path
     */
    const CRON_STRING_PATH = 'crontab/default/jobs/effectconnect_marketplaces_export_catalog/schedule/cron_expr';

    /**
     * Cron model path
     */
    const CRON_MODEL_PATH = 'crontab/default/jobs/effectconnect_marketplaces_export_catalog/run/model';
